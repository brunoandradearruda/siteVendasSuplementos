...
export default function Home() {
  // Seleciona produtos para destaque (IDs: 1-Whey Dux, 20-Creatina Soldiers, 41-Pre Treino Diablo)
  const destaques = [1, 20, 41].map(id => listaDeProdutos.find(p => p.id === id)).filter(Boolean);

  // Lista de vídeos educativos ATUALIZADA COM SEUS LINKS
  const videosEducativos = [
    {
      titulo: "Whey Protein: O Guia Definitivo",
      canal: "Paulo Muzy",
      id: "KeSFEemVJ9Q", // Vídeo do Whey (Muzy)
      categoria: "Proteína"
    },
    {
      titulo: "Tudo sobre Creatina (Mitos e Verdades)",
      canal: "Renato Cariani",
      id: "fXSSzOqAN6U", // Vídeo da Creatina (Cariani)
      categoria: "Creatina"
    },
    {
      titulo: "Pré-Treino: Para que serve e quando utilizar?",
      canal: "Leandro Twin",
      id: "hRm9hNCuNGc", // NOVO: Vídeo do Pré-Treino
      categoria: "Pré-Treino"
    },
    {
      titulo: "Hipercalórico: O segredo para ganhar peso rápido",
      canal: "Leandro Twin",
      id: "q1duJHJ-X0M", // NOVO: Vídeo do Hipercalórico
      categoria: "Hipercalórico"
    },
    {
      titulo: "BCAA: Ainda vale a pena investir nesse suplemento?",
      canal: "Leandro Twin",
      id: "tdLyrTWjMEY", // NOVO: Vídeo do BCAA
      categoria: "BCAA"
    },
    {
      titulo: "Albumina: A melhor proteína barata do mercado?",
      canal: "Leandro Twin",
      id: "DlBi8f_3jNo", // NOVO: Vídeo da Albumina
      categoria: "Albumina"
    }
  ];
              ...
              <div className="bg-white rounded-2xl p-8 h-full border border-slate-100 shadow-md hover:shadow-2xl transition-all duration-300 transform group-hover:-translate-y-2">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="relative w-12 h-12">
                     <Image src={categoria.imagemCapa} alt={categoria.nome} fill className="object-contain" />
                  </div>
                </div>
