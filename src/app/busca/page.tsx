"use client"; // Agora roda no navegador do usuário
...
// Componente interno que lê a busca
function ResultadosBusca() {
  const searchParams = useSearchParams();
  const q = searchParams.get('q'); // Pega o termo da URL
...
// Página principal com Suspense (Obrigatório para build estático)
